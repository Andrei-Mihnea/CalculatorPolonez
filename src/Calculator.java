...
public class Calculator extends JFrame {
    ...
    private void evaluateExpression() {
        try {
            String result = evalPolish(polish(expression));
            area.append(" = " + result);
            expression = result;
        } catch (Exception e) {
    ...
    private String polish(String expression) {
        ...
        for (char c : expression.toCharArray()) {
            if (Character.isDigit(c)) {
                ...
                // Operator
                while (!stack.isEmpty() && operatorOder(stack.peek()) >= operatorOder(c)) {
                    result.append(' ').append(stack.pop());
                }
                result.append(' ');
                stack.push(c);
    ...
    private String evalPolish(String Expression) {
    ...
    private int operatorOder(char operator) {
        switch (operator)
        {
